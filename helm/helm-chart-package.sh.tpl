...
if ! [ "{PACKAGE_OUTPUT_PATH}/{HELM_CHART_NAME}-$HELM_CHART_VERSION.tgz" = "{PACKAGE_OUTPUT_PATH}/{OUTPUT_NAME}" ]; then
    mv {PACKAGE_OUTPUT_PATH}/{HELM_CHART_NAME}-$HELM_CHART_VERSION.tgz {PACKAGE_OUTPUT_PATH}/{OUTPUT_NAME}
fi

echo "Successfully packaged chart and saved it to: {PACKAGE_OUTPUT_PATH}/{OUTPUT_NAME}"
